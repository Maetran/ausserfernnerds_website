...
function ein(x)
{
    document.getElementById("idUnter" + x).style.visibility = "visible";
}

function aus(x)
{
    document.getElementById("idUnter" + x).style.visibility = "hidden";
}
=======
...
>>>>>>> 0834a7acaec71dd1706d990620ac40e211ce71bf
